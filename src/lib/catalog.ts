...
export const catalog: Product[] = [
  ...
  },
  {
    ...
    form: "Bottle",
    priceUsd: 25,
    tagline: "Proprietary research blend.",
    description: "Super Human Blend supplied in a 10mL glass bottle. Intended for laboratory research applications. Manufactured to high purity standards. Not for human or animal consumption.",
