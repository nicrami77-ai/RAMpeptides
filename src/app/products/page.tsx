      ...
      <section className="px-6 lg:px-10">
        <div className="max-w-7xl mx-auto py-16 md:py-24">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            {catalog.filter(p => !["rubber-caps", "reconstitution-vial-10ml", "vault-case", "slim-can-cooler", "workout-tshirt-2xl", "ghk-cu-blue-copper-serum", "ghk-cu-blue-copper-serum-30ml"].includes(p.slug)).map((p) => (
